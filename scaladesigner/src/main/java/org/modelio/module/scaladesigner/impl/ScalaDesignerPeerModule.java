 ...
 *
 */
public class ScalaDesignerPeerModule implements IScalaDesignerPeerModule {
    private ScalaDesignerModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	public ScalaDesignerPeerModule(ScalaDesignerModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
